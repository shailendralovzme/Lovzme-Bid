...
public class Wish {
    ...
    @SerializedName("id_iqitwishlist_product")
    @Expose
    public String idIqitwishlistProduct;
    ...
    public String getIdIqitwishlistProduct() {
        return idIqitwishlistProduct;
    }

    public void setIdIqitwishlistProduct(String idIqitwishlistProduct) {
        this.idIqitwishlistProduct = idIqitwishlistProduct;
    }
