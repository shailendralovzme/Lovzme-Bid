...
public class Payload {
    ...
    @Expose
    public Object ipRegistrationNewsletter;
    @SerializedName("newsletter_date_add")
    @Expose
    public String newsletterDateAdd;
    ...
    @Expose
    public String outstandingAllowAmount;
    @SerializedName("show_public_prices")
    @Expose
    public String showPublicPrices;
    @SerializedName("max_payment_days")
    @Expose
    public String maxPaymentDays;
    ...
    @Expose
    public String resetPasswordValidity;
